...
// In a real implementation, you would import your actual supabase client
const mockSupabase = {
  from: () => ({
    select: () => ({
      order: () => ({
...
// Use this as a replacement for the actual supabase client
  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center h-64">
        <div className="text-xl font-medium text-gray-600">Loading latest products...</div>
      </div>
    );
  }

  return (
    <div className="products-carousel-container relative">
          ...
          {latestProducts.map(product => (
            <div key={product.id} className="product-card">
              <div className="product-image-container">
                <img
                  src={
                    product.product_images?.[0]?.image_path || 'https://via.placeholder.com/300x400'
                  }
                  alt={product.name}
